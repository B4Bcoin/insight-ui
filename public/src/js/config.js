...
.constant('Constants', {
    ...
    DEFAULT_CURRENCY: localStorage.getItem('insight-currency') || 'B4B'
...
angular.module('insight').config(function($routeProvider) {
  $routeProvider.
    ...
    when('/blocks', {
      ...
      title: 'B4bcoin Blocks solved Today'
    }).
    when('/blocks-date/:blockDate/:startTimestamp?', {
      templateUrl: 'views/block_list.html',
      title: 'B4bcoin Blocks solved '
    }).
    when('/address/:addrStr', {
      templateUrl: 'views/address.html',
      title: 'B4bcoin Address '
    }).
	 when('/charts', {
